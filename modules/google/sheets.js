...
function generateMember(sheetsMember) {
    return {
        ...
        primaryEmail: sheetsMember[MEMBER_INDICES.PrimaryEmail].toLowerCase().trim(),
        secondaryEmail: sheetsMember[MEMBER_INDICES.SecondaryEmail].toLowerCase().trim(),
        directorName: sheetsMember[MEMBER_INDICES.DirectorName],
        directorEmail: sheetsMember[MEMBER_INDICES.DirectorEmail].toLowerCase().trim(),
...
function convertMembersDict(sheetsMembers) {
    ...
    sheetsMembers.forEach(mem => {
        const newMem = {
            ...
            primaryEmail: mem[MEMBER_INDICES.PrimaryEmail].toLowerCase().trim(),
            secondaryEmail: mem[MEMBER_INDICES.SecondaryEmail].toLowerCase().trim(),
            directorName: mem[MEMBER_INDICES.DirectorName],
            directorEmail: mem[MEMBER_INDICES.DirectorEmail].toLowerCase().trim(),
